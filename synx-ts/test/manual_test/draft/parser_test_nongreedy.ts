...
const cases: CaseDef[] = [
    ...
    },
    {
        ...
        src: "c",
        seq: completePatternSeq({ sub_nodes: [A, B, C], sub_quantifiers: "?? ", raw: false, sep: null, accept_trailing_sep: false, ignore: null, greedy_flags: [false, false, true] }),
    ...
    },
    {
        ...
        src: "a,a,5",
        seq: completePatternSeq({ sub_nodes: [A, Five], sub_quantifiers: "+ ", raw: false, sep: Comma, accept_trailing_sep: false, ignore: null, greedy_flags: [false, true] }),
        note: "观察 A+? \\sep ',' 后接 5：第二个逗号不应被 A+? 的重复间隔吞掉，应留给子节点间 sep。",
    },
    {
        name: "ignore + end：ignore 由循环推进后再次检查 end",
        src: "aaa   b",
        seq: completePatternSeq({ sub_nodes: [A, B], sub_quantifiers: "* ", raw: false, sep: null, accept_trailing_sep: false, ignore: Space as ParserNode, greedy_flags: [false, true] }),
    ...
    },
    {
        ...
        src: "abc1rest",
        seq: completePatternSeq({ sub_nodes: [AnyChar, Digit], sub_quantifiers: "* " }),
