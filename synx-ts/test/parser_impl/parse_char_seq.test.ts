...
/** Quantifiers for CharSeq live in parseNode (same structure as PatternSeq) */
function test_parseNode_charSeq_quantifiers(): void {
...
function runAllTests(): void {
  ...
  test_parseCharSeq();
  test_parseNode_charSeq_quantifiers();
